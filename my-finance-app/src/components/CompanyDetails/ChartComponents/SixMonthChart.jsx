...
function SixMonthChart() {
  ...
  const URL = `https://cloud.iexapis.com/stable/stock/${ticker}/chart/6m?token=${APIKEY}`;
  ...
  async function fetchData() {
    ...
    setState({
      ...state,
      chartData: { ...state.chartData, SixMonthChartData: data },
    });
  }
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "6M movement, 1 day interval",
      },
    },
    scales: {
      x: {
  ...
  const localChartData = state.chartData.SixMonthChartData;
